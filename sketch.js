...
function preload(){
  kangaroo_running =   loadAnimation("assets/kangaroo2.png","assets/kangaroo1.png","assets/kangaroo3.png");
  kangaroo_collided = loadAnimation("assets/kangaroo2.png");
...
function draw() {
  ...
  stroke(3);
  fill("black")
  text("energy: "+ energy, camera.position.x,50);
...
function spawnShrubs() {
  ...
  if (frameCount % 150 === 0) {
    ...
    shrub.velocityX = -(6 + 3*energy/100)
    shrub.scale = 0.9;
...
function spawnObstacles() {
  if(frameCount % 120 === 0) {
    ...
    obstacle.velocityX = -(6 + 3*energy/100)
